...
const pricingPlans = [
    ...
    },
    {
        ...
        features: [
            ...
            "1 Session",
            "Chat interactions",
            "Former players, state level coaches",
        ],
    },
    {
        name: "Elite",
...
const Pricing = () => {
    ...
    const Heading = () => (
        <div className="relative z-10 my-12 flex flex-col items-center justify-center gap-4 px-4 md:px-0">
            <div className="flex w-full flex-col items-start justify-center space-y-4 md:items-center">
                ...
                <p className="mt-2 text-4xl font-extrabold tracking-tight text-white sm:text-5xl text-left md:text-center">
                    Flexible Pricing
                </p>
                <p className="text-md max-w-xl text-gray-200 text-left md:text-center">
    ...
    const PricingCards = () => (
        <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 lg:px-0 lg:flex-row lg:gap-4">
